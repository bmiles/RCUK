...
from mongosearch import mongodb_search
...
#Create another Document
facets = {'category': 'books', 'type': 'soft cover' }
text = "The Believing Brain: Forbidden Ghosts to Politics and Conspiracies---How We Construct Beliefs"
fields = {'Author': 'Michael Layton', 'Price': 12.10 }

mdb_search.index_document('id_3', text, facets=facets, ensure_index=['Author'], **fields)

#Create another Document
facets = {'category': 'books', 'type': 'hard cover' }
text = "The Believing Brain: Discover Gods and Ghosts to Politics and Conspiracies---How We Construct Beliefs"
fields = {'Author': 'Michael Stilton', 'Price': 31.12 }

mdb_search.index_document('id_4', text, facets=facets, ensure_index=['Author'], **fields)
